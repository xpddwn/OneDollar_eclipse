...
public class NetworkDelegateImpl implements INetworkDelegate {
	...
	public NetworkDelegateImpl(Handler handler, HashMap<String, Object> hashMap) {
		if (hashMap == null) {
			Log.e(TAG,
	...
	public NetworkDelegateImpl(Handler handler) {
		if (handler == null) {
			Log.e(TAG,
	...
	public void didFinishedLoad(Object resposeResult) {
		...
		try {
			...
			if (mEndMessageWhat == Constants.msg.MSG_LOGIN_SUCCESS
					|| mEndMessageWhat == Constants.msg.MSG_PHONE_LOGIN_SUCCESS) {
